...
<head>
    ...
    <title>Login sekarang dan segera berbelanja | Cobainaja</title>
...
<body>
    <div class="wrapper" style="height: 100vh;">
        ...
        <div class="container" style="padding: 70px 0;height: 100%">
            <h1 style="text-align: center;line-height: 1rem;margin: 1.5rem 0;">Ratelshop <br><span style="font-size: .8rem;font-weight: 400;">Welcome please Sign in!</span></h1>
            <?php
            session_start();
            ...
            if (isset($_POST['login'])) {
                ...
                if ($jmlh_data > 0) {
                    ...
                    echo "<center style='color: #fd1c1c;font-size: .9rem;'>Username atau Password Anda salah!</center>";
                    echo "<style>.input-form {border: 1px solid #fd1c1c !important;}</style>";
                }
            }
            ...
            <div class="dir-l" style="margin: 1.5rem 1rem;border: none;">
                <span class="dir" style="font-size: .8rem;color: #969696;">
                   Butuh bantuan?
                    <span style="color: #34fd42;">Hubungi Kami</span>
                </span>
            </div>
        </div>
        <script>
